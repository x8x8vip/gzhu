...
$(function(){
    $(".sbtn").click(function(){
        if($(this).hasClass("cur"))
        {
            ...
            $(".sy").show();
			$(this).html('收起<i class="sjbgs"></i><i class="sjbgx"></i>');
        }
        else{
        	$(".sy").hide();
            $(".sbtn").addClass("cur");
			$(this).html('展开<i class="sjbgs"></i><i class="sjbgx"></i>');
        }
    })
...
$(function(){ 
  ...
  $('html,body').animate({scrollTop: '0px'}, 800);}); 
  	...
  	/* 首页幻灯效果---------*/
	jQuery(".itxMovie").slide({ titCell:".ifocus_nav li", mainCell:".ifocus_pic", autoPlay:true,delayTime:1000,interTime:3000,startFun:function(i){
			//控制小图自动翻页
			if(i==0){ jQuery(".itxMovie .navPrev").click() } else if( i%10==0 ){ jQuery(".itxMovie .navNext").click()}
		}
	});
		//小图滚动
	jQuery(".itxMovie").slide({ mainCell:".ifocus_nav ul",prevCell:".navPrev",nextCell:".navNext",effect:"left",vis:10,scroll:10,delayTime:0,autoPage:true,pnLoop:false});
